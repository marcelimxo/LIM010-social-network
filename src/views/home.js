...
<div class="user-info">
  ...
  <div class="post-header">
    ...
    <button class="buttons btn-delete-post"><img src="/src/img/delete.png" alt="Borrar post"></button>
  </div>
  <textarea type="text" id="${id}" class="post" disabled>${doc.content}</textarea>
